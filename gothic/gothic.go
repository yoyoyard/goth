...
See https://github.com/yoyoyard/goth/blob/master/examples/main.go to see this in action.
*/
package gothic
...
See https://github.com/yoyoyard/goth/examples/main.go to see this in action.
*/
